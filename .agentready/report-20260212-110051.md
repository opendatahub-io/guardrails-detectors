...
**Path**: `/Users/ddahlem/Documents/repos/trusty/opendatahub-io/guardrails-detectors`
**Branch**: `main` | **Commit**: `8ee57c6a`
...
**Evidence**:
- CI config found: .github/workflows/security.yml, .github/workflows/tests.yml, .github/workflows/agentready-assessment.yml, .github/workflows/test-llm-judge.yaml, .github/workflows/security-scan.yaml, .github/workflows/sync-branch-incubation.yaml, .github/workflows/test-huggingface-runtime.yaml, .github/workflows/test-builtin-detectors.yaml, .github/workflows/sync-branch-stable.yaml
...
- **Repository Snapshot**: 8ee57c6a937ee77c0dddc351dafc638bbb6823e6
- **Assessment Duration**: 0.4s
